 ...
 */
public class ListHeader extends AbstractHeaderItem<FlexibleViewHolder> {
     ...
     */
    @Override
    public ListHeader.ListHeaderViewHolder createViewHolder(FlexibleAdapter adapter, LayoutInflater inflater,
                                                            ViewGroup parent) {
        return new ListHeader.ListHeaderViewHolder(inflater.inflate(getLayoutRes(), parent, false), adapter, true);
    }
    ...
    public int getLayoutRes() {
        return R.layout.shuffle_list_view;
    }
